...
1. **Start the Game**: The user initiates the game and receives a welcome message about the objective.
...
4. **Validate Input**: The input is checked:
   - **Invalid**: An error message asks for a number between 1 and 10.
